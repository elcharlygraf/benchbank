...
@section('header')
	<header id="inicio">
		<div class="contenedor">			
				<div class="empresa">		
					<figure class="logo"><a href="/"><img src="{{asset('assets/img/logo.jpg')}}" alt="benchbank"></a></figure>
				...
				<nav class="menu-l">
					...
					<a id="btn-quees"href="http://benchbank.com.pe/#quees">¿QUÉ ES?</a> </li>
					<a id="btn-formulario" href="http://benchbank.com.pe/#formulario">CONTACTO</a> </li>
				</nav>

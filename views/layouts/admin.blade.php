...
<head>
    ...
    <link href="{{asset('assets/assets/css/icons/icons.min.css')}}" rel="stylesheet">
    ...
    <link href="{{asset('assets/assets/css/style.min.css')}}" rel="stylesheet">
    <link href="#" rel="stylesheet" id="theme-color">
    <!-- END  MANDATORY STYLE -->
    <!-- BEGIN PAGE LEVEL STYLE -->
    <link href="{{asset('assets/assets/plugins/fullcalendar/fullcalendar.css')}}" rel="stylesheet">
    <link href="{{asset('assets/assets/plugins/metrojs/metrojs.css')}}" rel="stylesheet">
    <!-- END PAGE LEVEL STYLE -->
    <script src="{{asset('assets/assets/plugins/modernizr/modernizr-2.6.2-respond-1.1.0.min.js')}}"></script>
</head>
...
<body data-page="dashboard">
    ...
    <script src="{{asset('assets/assets/plugins/mandatoryJs.min.js')}}"></script>
    <!-- END MANDATORY SCRIPTS -->
    <!-- BEGIN PAGE LEVEL SCRIPTS -->
    <script src="{{asset('assets/assets/plugins/metrojs/metrojs.min.js')}}"></script>
    <script src="{{asset('assets/assets/plugins/fullcalendar/moment.min.js')}}"></script>
    <script src="{{asset('assets/assets/plugins/fullcalendar/fullcalendar.min.js')}}"></script>
    <script src="{{asset('assets/assets/plugins/simple-weather/jquery.simpleWeather.min.js')}}"></script>
    <script src="{{asset('assets/assets/plugins/google-maps/markerclusterer.js')}}"></script>
    <script src="http://maps.google.com/maps/api/js?sensor=true"></script>
    <script src="{{asset('assets/assets/plugins/google-maps/gmaps.js')}}"></script>
    <script src="{{asset('assets/assets/plugins/charts-flot/jquery.flot.js')}}"></script>
    <script src="{{asset('assets/assets/plugins/charts-flot/jquery.flot.animator.min.js')}}"></script>
    <script src="{{asset('assets/assets/plugins/charts-flot/jquery.flot.resize.js')}}"></script>
    <script src="{{asset('assets/assets/plugins/charts-flot/jquery.flot.time.min.js')}}"></script>
    <script src="{{asset('assets/assets/plugins/charts-morris/raphael.min.js')}}"></script>
    <script src="{{asset('assets/assets/plugins/charts-morris/morris.min.js')}}"></script>
    <script src="{{asset('assets/assets/plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js')}}"></script>
    <script src="{{asset('assets/assets/js/calendar.js')}}"></script>
    <script src="{{asset('assets/assets/js/dashboard.js')}}"></script>
    <!-- END  PAGE LEVEL SCRIPTS -->
    <script src="{{asset('assets/assets/js/application.js')}}"></script>
</body>

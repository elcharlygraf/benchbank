...
@section('cuerpo')
			...
			<section class="cabecera_deposito">
				<div class="leftbox">
					<figure class="iconprestamos"></figure>
			...
			<aside class="banner_prestamos"></aside>	
			...
			<section class="boxopciones_prestamos">
				<a href="prestamos/consumo">
				<div id="boxdeposito_opciones" class="boxconsumo"></div>
				</a>

				<a href="prestamos/vehicular">
				<div id="boxdeposito_opciones" class="boxvehicular"></div>
				</a>

				<a href="prestamos/hipotecario">
				<div id="boxdeposito_opciones" class="boxhipotecario"></div>
				</a>
				<br>
			</section>
@stop

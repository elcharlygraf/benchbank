...
@section('cuerpo')	
			...
			<section class="calculobox">
				<div class="imagenCalculo_PrestamoHipotecario"></div>
				...
				<div class="content_calculo">
					{{Form::open(['route' => array('SearchHipotecario', '3'), 'id' => 'calculoForm' ,'method' => 'POST', 'role' => 'form', 'class' => 'formCalculo']) }}
						...
						<div class="bloqueFormCalculo">
							...
							<div style="display:block">	
								<div class="inputblock">
									<input type="radio" name="check" id="0"	value="0" checked /> %
								</div>

								<div class="inputblock">
									<input type="radio" name="check" id="1"  value="1" /> 0.00
								</div>
							</div>	
						...
						<div class="bloqueFormCalculo">
							<input type="hidden" name="producto" value="Hipotecario">

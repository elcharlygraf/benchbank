...
@section('cuerpo')
			...
			<section class="calculobox">
				<div class="imagenCalculo_PrestamoVihicular"></div>
				...
				<div class="content_calculo">
					{{Form::open(['route' => array('SearchVehicular', '2'), 'id' => 'calculoForm', 'method' => 'POST', 'role' => 'form', 'class' => 'formCalculo']) }}
						...
						<div class="bloqueFormCalculo">
							...
							<div style="display:block">		
								<div class="inputblock">
									<input type="radio" name="typecuota" id="0"	value="0" checked /> %
								</div>

								<div class="inputblock">
									<input type="radio" name="typecuota" id="1"  value="1" /> 0.00
								</div>
							</div>	
                            {{ Form::number('cuota_inicial', null, ['class' => 'formCalculo_input', 'placeholder' => 'Escribe el importe', 'required']) }}
						...
						<div style="display:block">	
                            ...
                            {{ Form::number('plazos', null, ['class' => 'formCalculo_input', 'id' =>'plazos', 'placeholder' => 'Cantidad los plazos', 'required']) }}
						...
						<div class="bloqueFormCalculo">
							<input type="hidden" name="producto" value="Vehicular">
